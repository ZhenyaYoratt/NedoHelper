...
os.system('pyinstaller main.py --onefile -n YoHelper --add-data dist:tts.exe --windowed --uac-admin --optimize 2 --upx-dir "C:\\upx-4.2.4-win64" --icon=icon.ico --splash=splash.png')
